      ...
      <div className="bg-surface rounded-2xl border-2 border-border p-6">
        <div className="space-y-4">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <button
                ...
                className="px-3 py-2 bg-surface-secondary hover:bg-border rounded transition-colors text-sm font-medium"
                title="Copy route ID"
              >
                📋
              </button>
          ...
          <button
            ...
            className="w-full mt-4 py-2 px-4 bg-gradient-to-r from-primary to-primary-light text-white font-semibold rounded-lg hover:shadow-lg transition-all"
          >
            Copy Share Link
          </button>
        </div>
