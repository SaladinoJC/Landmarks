        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            {isEditing ? (
              ...
              <h1 className="text-2xl font-bold text-text-primary truncate">{route.name}</h1>
            )}
          </div>
            ...
            {isEditing ? (
              <>
                <button
                  ...
                  className="px-4 py-2 bg-surface-secondary text-text-primary font-semibold rounded-lg hover:bg-border transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={isSaving}
                  className="px-4 py-2 bg-success text-white font-semibold rounded-lg hover:opacity-90 disabled:opacity-50 transition-colors"
                >
              ...
              isAuthor && (
                <button
                  ...
                  className="px-4 py-2 bg-accent text-white font-semibold rounded-lg hover:opacity-90 transition-colors"
                >
                  Edit Route
                </button>
              )
